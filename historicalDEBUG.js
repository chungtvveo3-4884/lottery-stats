            ...
            if (streak) {
                ...
                if (isSoLeMoi && targetLotteryDay && targetLotteryDay.special !== undefined) {
                    try {
                        ...
                        const matchNumbers = getNumbersFromCategory(categoryName);
                ...
                if (key === 'tong_tt_chan:veSole' && targetDateStr === '06/03/2026') { console.log('DEBUG: matched key! streak=', !!streak, 'targetLotteryDay=', !!targetLotteryDay, 'targetLotteryDay.special=', targetLotteryDay ? targetLotteryDay.special : 'N/A', 'isValid=', isValid); }
                if (isValid) {
                    current = {
                        ...streak,
