...
const statFunctionsMap = {
    ...
    'consecutiveDoubleNumbers': { func: (data, start, end, days) => lotteryService.findConsecutiveDoubleNumbers(data, start, end, 'de', days), minDays: 2 },
    'consecutiveOffsetDoubleNumbers': { func: (data, start, end, days) => lotteryService.findConsecutiveOffsetDoubleNumbers(data, start, end, 'de', days), minDays: 2 },
    ...
    'sum_inc_trad': { func: (data, start, end, days) => lotteryService.findConsecutiveSumIncreasingNumbers(data, start, end, 'de', days, 'traditional'), minDays: 2 },
    'sum_dec_trad': { func: (data, start, end, days) => lotteryService.findConsecutiveSumDecreasingNumbers(data, start, end, 'de', days, 'traditional'), minDays: 2 },
    'sum_seq_asc_trad': { func: (data, start, end, days) => lotteryService.findConsecutiveSumSequences(data, start, end, 'asc', 'de', days, 'traditional'), minDays: 2 },
    'sum_seq_desc_trad': { func: (data, start, end, days) => lotteryService.findConsecutiveSumSequences(data, start, end, 'desc', 'de', days, 'traditional'), minDays: 2 },
    'sum_inc_new': { func: (data, start, end, days) => lotteryService.findConsecutiveSumIncreasingNumbers(data, start, end, 'de', days, 'new'), minDays: 2 },
    'sum_dec_new': { func: (data, start, end, days) => lotteryService.findConsecutiveSumDecreasingNumbers(data, start, end, 'de', days, 'new'), minDays: 2 },
    'sum_seq_asc_new': { func: (data, start, end, days) => lotteryService.findConsecutiveSumSequences(data, start, end, 'asc', 'de', days, 'new'), minDays: 2 },
    'sum_seq_desc_new': { func: (data, start, end, days) => lotteryService.findConsecutiveSumSequences(data, start, end, 'desc', 'de', days, 'new'), minDays: 2 },
    'sum_consecutive_trad': { func: (data, start, end, days) => lotteryService.findConsecutiveSum(data, start, end, 'de', days, 'traditional'), minDays: 2 },
    'sum_consecutive_new': { func: (data, start, end, days) => lotteryService.findConsecutiveSum(data, start, end, 'de', days, 'new'), minDays: 2 },
    ...
    'sum_even_odd_trad_even_asc': { func: (data, start, end, days) => findEvenOddSumSequences(data, start, end, 'de', days, 'traditional', 'even', 'ascending'), minDays: 2 },
    'sum_even_odd_trad_even_desc': { func: (data, start, end, days) => findEvenOddSumSequences(data, start, end, 'de', days, 'traditional', 'even', 'descending'), minDays: 2 },
    'sum_even_odd_trad_odd_asc': { func: (data, start, end, days) => findEvenOddSumSequences(data, start, end, 'de', days, 'traditional', 'odd', 'ascending'), minDays: 2 },
    'sum_even_odd_trad_odd_desc': { func: (data, start, end, days) => findEvenOddSumSequences(data, start, end, 'de', days, 'traditional', 'odd', 'descending'), minDays: 2 },
    'sum_even_odd_new_even_asc': { func: (data, start, end, days) => findEvenOddSumSequences(data, start, end, 'de', days, 'new', 'even', 'ascending'), minDays: 2 },
    'sum_even_odd_new_even_desc': { func: (data, start, end, days) => findEvenOddSumSequences(data, start, end, 'de', days, 'new', 'even', 'descending'), minDays: 2 },
    'sum_even_odd_new_odd_asc': { func: (data, start, end, days) => findEvenOddSumSequences(data, start, end, 'de', days, 'new', 'odd', 'ascending'), minDays: 2 },
    'sum_even_odd_new_odd_desc': { func: (data, start, end, days) => findEvenOddSumSequences(data, start, end, 'de', days, 'new', 'odd', 'descending'), minDays: 2 },
...
const getConsecutiveDoubleNumbers = async (req, res) => {
    ...
    if (data) {
        ...
        const { results, total, message } = lotteryService.findConsecutiveDoubleNumbers(data, startDate, endDate, mode, consecutiveDays) || { results: [], total: 0, message: "" };
        ...
        res.render('consecutiveDoubleNumbers', {
            results,
            startDate,
            endDate,
            sortOrder,
...
const getConsecutiveOffsetDoubleNumbers = async (req, res) => {
    ...
    if (data) {
        ...
        const { results, total, message } = lotteryService.findConsecutiveOffsetDoubleNumbers(data, startDate, endDate, mode, consecutiveDays) || { results: [], total: 0, message: "" };
        ...
        res.render('consecutiveOffsetDoubleNumbers', {
            results,
            startDate,
            endDate,
            sortOrder,
...
const getConsecutiveSumNumbers = async (req, res) => {
    const data = req.lotteryData;
    if (data) {
        const startDate = req.query.startDate || lotteryService.getDefaultStartDate();
        const endDate = req.query.endDate || lotteryService.getCurrentDate();
        ...
        try {
            const { results, total, message } = lotteryService.findConsecutiveSumNumbers(
                data,
                startDate,
                endDate,
                order,
            ...
            res.render('consecutiveSumNumbers', {
                results,
                startDate,
                endDate,
                order,
            ...
            console.error('Lỗi trong getConsecutiveSumNumbers:', error);
            res.render('consecutiveSumNumbers', {
                results: [],
                startDate,
                endDate,
...
const getConsecutiveSumIncreasingNumbers = async (req, res) => {
    const data = req.lotteryData;
    if (data) {
        const startDate = req.query.startDate || lotteryService.getDefaultStartDate();
        const endDate = req.query.endDate || lotteryService.getCurrentDate();
        const sortOrder = req.query.sortOrder || 'desc';
        const mode = req.query.mode || 'lo';
        const consecutiveDays = parseInt(req.query.consecutiveDays) || 3;
        const sumType = req.query.sumType || 'traditional';

        try {
            const { results, total, message } = lotteryService.findConsecutiveSumIncreasingNumbers(
                data,
                startDate,
                endDate,
                mode,
            ...
            res.render('consecutiveSumIncreasingNumbers', {
                results,
                startDate,
                endDate,
                sortOrder,
            ...
            console.error('Lỗi trong getConsecutiveSumIncreasingNumbers:', error);
            res.render('consecutiveSumIncreasingNumbers', {
                results: [],
                startDate,
                endDate,
...
const getConsecutiveSumDecreasingNumbers = async (req, res) => {
    const data = req.lotteryData;
    if (data) {
        const startDate = req.query.startDate || lotteryService.getDefaultStartDate();
        const endDate = req.query.endDate || lotteryService.getCurrentDate();
        ...
        try {
            const { results, total, message } = lotteryService.findConsecutiveSumDecreasingNumbers(
                data,
                startDate,
                endDate,
                mode,
            ...
            res.render('consecutiveSumDecreasingNumbers', {
                results,
                startDate,
                endDate,
                sortOrder,
            ...
            console.error('Lỗi trong getConsecutiveSumDecreasingNumbers:', error);
            res.render('consecutiveSumDecreasingNumbers', {
                results: [],
                startDate,
                endDate,
...
const getConsecutiveSumSequences = async (req, res) => {
    const data = req.lotteryData;
    if (!data) {
        return res.status(500).send('Lỗi: Không thể tải dữ liệu xổ số.');
    }
    ...
    try {
        ...
        const { results, total, message } = lotteryService.findConsecutiveSumSequences(
            data,
            startDate,
            endDate,
            order,
        ...
        res.render('consecutiveSumSequences', {
            results,
            startDate,
            endDate,
            sortOrder,
        ...
        console.error('Lỗi trong getConsecutiveSumSequences:', error);
        res.render('consecutiveSumSequences', {
            results: [],
            startDate,
            endDate,
...
const getEvenOddSumSequences = async (req, res) => {
    const data = req.lotteryData;
    if (!data) {
        return res.status(500).send('Lỗi: Không thể tải dữ liệu xổ số.');
    }
    ...
    try {
        ...
        const sequenceType = req.query.sequenceType || 'even';
        const pattern = req.query.pattern || 'ascending';

        const { results, total, message } = findEvenOddSumSequences(
            data,
            startDate,
            endDate,
            mode,
        ...
        // Sort results by date if needed
        results.sort((a, b) => {
            const dateA = new Date(a.dates[0]);
            const dateB = new Date(b.dates[0]);
            return sortOrder === 'asc' ? dateA - dateB : dateB - dateA;
        ...
        res.render('evenOddSumSequences', {
            results,
            startDate,
            endDate,
            sortOrder,
        ...
        console.error('Lỗi trong getEvenOddSumSequences:', error);
        res.render('evenOddSumSequences', {
            results: [],
            startDate: req.query.startDate || lotteryService.getDefaultStartDate(),
            endDate: req.query.endDate || lotteryService.getCurrentDate(),
            ...
            sequenceType: req.query.sequenceType || 'even',
            pattern: req.query.pattern || 'ascending',
            formatDate: lotteryService.formatDate,
...
// File: controllers/lotteryController.js
...
const getAdvancedSequences = async (req, res) => {
    ...
    try {
        const options = {
            ...
            sumType: req.query.sumType || 'traditional',
            sumParity: req.query.sumParity || 'even',
        ...
        const createTitle = () => {
            ...
            // [SỬA LỖI TẠI ĐÂY] - Thêm một đối tượng để ánh xạ sang tiếng Việt
            const parityMap = {
                'even-even': 'Chẵn - Chẵn',
                'even-odd': 'Chẵn - Lẻ',
                'odd-even': 'Lẻ - Chẵn',
        ...
        res.render('advancedResultPage', { title, results, total, message, options, formatDate: lotteryService.formatDate });
...
module.exports = {
    ...
    getConsecutiveSumNumbers,
    getConsecutiveSumIncreasingNumbers,
    getConsecutiveSumDecreasingNumbers,
    getConsecutiveSumSequences,
    getParitySequenceNumbers,
    getEvenOddSumSequences,
    getSoleSumSequences,
